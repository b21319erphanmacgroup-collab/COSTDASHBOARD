			...
			<div class="sidebar">
	            ...
	            <div class="nav-wrap">
					...
					<div class="footer-container">
					    <div class="left-wrap">
					        <div class="user-info">
					            <span class="user-name">{$user.0.USER_NAME} {$user.0.GRADE_NAME}</span>
					            <span class="user-role"></span>
					        </div>
					        <div class="company-name">{$user.0.TEAM_NAME}</div>
					    </div>
	    ...
	    <main class="main-container">
	        ...
	        <div class="page-header">
	            <div class="page-header__left">
	                <h3 class="page-header__title">{$user.0.TEAM_NAME}
	                    <img src="../../dashboard/images/common/icon-information.svg" alt="이력관리" class="tool-tip-history" id="toolTipHistory" data-tooltip-trigger="historyModal">
	                </h3>
	                <!-- 이력관리 모달 시작 -->
