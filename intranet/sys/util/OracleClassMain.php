	...
	****************************************/
	...
	class OracleClass {
		...
		function OracleClass($smarty)
		{
			...
			// $this->connection = oci_connect('satis', 'SATIS11707808', 'HANMACDB_CLOUD');  //변경클라우드
			$this->connection = oci_connect('brerp', 'brerp11707808', 'brerp');  //변경클라우드_바론
		}

		function db_close_oracle()
		{
			if($this->connection)
