	...
	while($record4 = mysql_fetch_array($recordBlock4)) {
		...
		if($g_code <= $LAST_GROUP_CODE_NO) {  //"정통" "경영" "영업" "관리" "교휴"
			...
			for($k=1; $k<=4; $k++) {
				...
				$azSQL = "SELECT * FROM change_list_tbl WHERE ProjectCode like '%$g_name%' and ChangeItem like '%$DETAIL_OP1%' and ChangeDate >= '$StDate' and  ChangeDate < '$EdDate' order by ProjectCode asc, ChangeDate asc";
//echo $azSQL."<br>";
				...
				if(mysql_num_rows($recordBlock5) > 0) {
					...
					while($record5 = mysql_fetch_array($recordBlock5)) {
						...
						$g_Prn = $g_Prn."<tr>";
							...
							//$g_Prn = $g_Prn."<td tbl_right_border_bottom_border_t_right bgcolor=#FFFFFF height=30 title=$g_Note>s".number_format($g_ChangePrice / 1000)."&nbsp;</td>";
					...
					$g_Prn = $g_Prn."<tr>";
						...
						$g_Prn = $g_Prn."<td class=tbl_right_border_bottom_border_t_right height=30>&nbsp;</td>";
						//$g_Prn = $g_Prn."<td tbl_right_border_bottom_border_t_right>&nbsp;</td>";
			...
			$g_Prn = $g_Prn."<tr>";
				...
				$g_Prn = $g_Prn."<td class=tbl_right_border_bottom_border_t_right height=30>&nbsp;</td>";
				$g_Prn = $g_Prn."<td class=tbl_right_border_bottom_border_t_right height=30>&nbsp;</td>";
				//$g_Prn = $g_Prn."<td class=tbl_right_border_bottom_border_t_right>&nbsp;</td>";
