<?	
	...
	****************************************/
	...
	include "../model/private_logic.php";
	...
	$CurrentLogic=new PrivateLogic($smarty);
	...
	else if($ActionMode=="read_list")
		$CurrentLogic->ReadList();	
	else if($ActionMode=="read_input")
		$CurrentLogic->ReadInput();	
	else if($ActionMode=="read_save")
		$CurrentLogic->ReadSave();	
	else if($ActionMode=="read_detail")
		$CurrentLogic->ReadDetail();	
	else if($ActionMode=="read_update")
		$CurrentLogic->ReadUpdate();	
	else if($ActionMode=="read_del")
		$CurrentLogic->ReadDelete();	
	else if($ActionMode=="SubCode")
		$CurrentLogic->SubCode();
	else
		$CurrentLogic->View();
