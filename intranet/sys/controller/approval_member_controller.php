<?php
	...
	****************************************/ 
	...
	include "../model/aproval_member_logic.php";
	...
	$CurrentLogic=new ApprovalMemberLogic($smarty);

	
	if($ActionMode=="ApprovalMemberSelect")				
		$CurrentLogic->ApprovalMemberSelect();
	else 
		$CurrentLogic->ApprovalMemberChange();
