...
<?php
	...
	****************************************/
	...
	include "../../../apiLibrary/common.lib.php";

	extract($_POST);
	class AuthPayLogic {
		var $smarty;
		function AuthPayLogic($smarty)
		{
			$this->smarty=$smarty;
		}
        ...
        function getToken() {
			...
			if($test !== 'Y'){
				if($CompText == "SAMA"){	
					$EMP_NO="T02303"; $EMP_NAME="신현우"; $COMP_CODE="20";
				}
				elseif($CompText == "HANM"){ 
					$EMP_NO="M22014"; $EMP_NAME="김한결"; $COMP_CODE="20";
				}
				elseif($CompText == "BARO"){ 
					$EMP_NO="B22030"; $EMP_NAME="이용근"; $COMP_CODE="30";
				}
				elseif($CompText == "JANG"){ 
					$EMP_NO="J16202"; $EMP_NAME="이중경"; $COMP_CODE="40";
				}
				elseif($CompText == "HALL"){
					$EMP_NO="M22014"; $EMP_NAME="장채운"; $COMP_CODE="50";
				}
				elseif($CompText == "PILE"){
					$EMP_NO="P22301"; $EMP_NAME="김민준"; $COMP_CODE="60";
				}
				elseif($CompText == "HYUN"){
					$EMP_NO="H24301"; $EMP_NAME="이운옥"; $COMP_CODE="70";
				}
			...
			$crypto = new Crypto();  // 암호화/복호화 처리 클래스
			$result = $crypto -> encrypt($token_data);
            echo $result;
        }
