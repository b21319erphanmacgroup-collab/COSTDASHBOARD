	...
	****************************************/
	...
	class CooperationLogic {
		...
		function ListPage()
		{
			...
			if($memberID != "B20334" && $memberID != "B23007"){
				$sql.=" AND (send_member LIKE '%$memberID%' OR n_num = '$memberID')";
			}
...
//echo $sql;
			...
			$this->smarty->display("intranet/common_contents/work_approval/cooperation_list_mvc.tpl");
		}
		...
		function InsertPage()
		{
			...
			$this->smarty->assign('MyGroupCode',$_SESSION["MyGroupCode"]);
			...
			$this->smarty->assign("page_action","cooperation_controller.php");
			$this->smarty->display("intranet/common_contents/work_approval/cooperation_input_mvc.tpl");
		...
		function InsertAction()
		{
			...
			$path ="./../../../intranet_file/notice/cooperate_new/";
			$path_is ="./../../../intranet_file/notice/cooperate_new";
			...
			if ($userfile_name <>"" && $userfile_size <>0)
			{
				...
				*/
				...
				$filename="./cooperate_new/".$userfile_name;
			...
			if ($userfile2_name <>"" && $userfile2_size <>0)
			{
				...
				$filename2="./cooperate_new/".$userfile2_name;
			...
			if($_REQUEST["confirm_members"] != ""){
				$send_member .= str_replace("0:","",$_REQUEST["confirm_members"]);
			}
		...
		function UpdateReadPage()
		{
			...
			if($mode=="mod")
				...
				$this->smarty->display("intranet/common_contents/work_approval/cooperation_read_mvc.tpl");
		}
