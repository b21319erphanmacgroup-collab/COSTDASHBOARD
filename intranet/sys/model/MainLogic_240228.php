...
/* ******************************************************************************************* */
	...
	function VacationList(){
		...
		//M16216 환경평가부 이병욱 부장 팀장직급 퇴사로 인한 임시 팀장 권한 요청(23.07.31PM16:17)
		$RankCode=substr($RankCode,0,2);
		if($RankCode<="C8" || $memberID=="M21420"|| $memberID=="Tadmin" || $memberID == "B18214" || $memberID == "J08305" || $memberID == "M16216"){   //이사이상
