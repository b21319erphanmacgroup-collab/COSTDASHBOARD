...
//echo $MemberNo.":01<br>";
		...
		$get_memberID	= $_COOKIE['CK_memberID'];
...
// 			echo 'd_EntryPCode_edit='.$d_EntryPCode_edit.'<BR><BR>';
	...
	function editWork()	//업무수정  DB실행
	{
		...
		/* ----------------------------------- */
		$sql2    = "select COUNT(*) CNT from dallyproject_tbl where MemberNo = '".$MemberNo."' and  EntryTime like '".$date_today."%'";
		/* ----------------------------------- */
		$re2          = mysql_query($sql2);
	...
	/* ------------------------------------------------------------------------------ */
	function EndWorkPop_old()	//페이지이동 : 업무종료
	{
		global	$CompanyKind; // 회사코드
		global	$MemberNo;	  // 사원번호
		global	$korName;	  // 한글이름
