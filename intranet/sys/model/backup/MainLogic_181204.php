	...
	/**/
        ...
        ************************/
		...
		for($i=0;$i<31;$i++){
			...
			$sql33 .=	"				 AND																							";
			$sql33 .=	"				 state <> '15'																					";/*조건추가 : 20160114 : state=15 인 인원(파견B)은 출근 등 기타내역을  본사근무자와 동일하게 표시 End */
			$sql33 .=	"		) a left JOIN																							";
			$sql33 .=	"	(																											";
			...
			if($re_num_code33 != 0) {
				...
				if($re_num_code99 != 0) {
					...
					$d_EntryMin = @mysql_result($re_code99,0,"d_EntryMin");
						...
						$holyCheck = holy($d_ViewDate); //평일:weekday : holy() : /inc/function_intranet.php파일내 FUNCTION
						if($holyCheck == "weekday"){
								if($memberID=="J15205" || $memberID=="M13301"  || $memberID=="J15306" || $memberID=="B18213") //2017-08-18 김도훈 09:30출근 임시  //2018-04-10 이광태 09:30 출근 //180502 김세열 B18213 류한솔
								{	
