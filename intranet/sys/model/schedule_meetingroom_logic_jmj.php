	...
	****************************************/
	...
	class ScheduleMeetingroomLogic {
		...
		function InsertPage()
		{
			...
			$sql = "select Code, Name, Description from systemconfig_tbl where SysKey='meetingroom' order by orderno";
			...
			$this->smarty->display("intranet/common_contents/work_meetingroom/meetingroom_input_mvc_jmj.tpl");
		}
		...
		function View()
		{
			...
			$this->smarty->assign("page_action","schedule_meetingroom_controller.php");
			$this->smarty->display("intranet/common_contents/work_meetingroom/meetingroom_contents_mvc_jmj.tpl");
		}
		//============================================================================
		// 시간체크
		//============================================================================
