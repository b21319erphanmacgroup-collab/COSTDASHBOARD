...
// A.memberno='M21407'
    ...
    if($re_num > 0) {
        ...
        while($re_row = mysql_fetch_array($re))
        {
			...
			$re_row[vacation]=$re_row[vacationplus];
...
//$vb_member_info= $re_row[Groupnames].",".$re_row[korName].",".$re_row[RankCodes];
                ...
                */
                ...
                if($isNoticeDay2 && $re_row[remaind_day] > "0.4" && ($year_end2 <= $Todays)){
                    $vb_member_info= iconv('euc-kr', 'utf-8', $vb_member_info);
                    //$sql="insert into vacation_boost_tbl_test (MemberNo ,create_year ,create_month ,degree ,notice_day ,status ,submit_YN ,check_YN ,notes ,remaind_day ,UpdateDate)
                    //values('$re_row[MemberNo]','$this_year','$this_month','1','$year_end1','0','N','N','$year_end1_note','$re_row[remaind_day]',now()); ";
                    // 기존년도, 차수에 사용자 삭제
                    $sql  = " Delete ";
                    $sql .= " From ";
                    $sql .= "     vacation_boost_tbl_test ";
                    $sql .= " Where vb_member_no = '$re_row[MemberNo]' ";
                    $sql .= " And vb_degree = '2' ";
                    $sql .= " And vb_create_year = '$this_year' and vb_etc_05 ='' ";
                    $resource = mysql_query($sql, $db);

                    $sql="insert into vacation_boost_tbl_test (vb_member_no, vb_notice_dt, vb_degree, vb_create_year, vb_create_month, vb_status, vb_use_day, vb_remaind_day, vb_update_dt, vb_member_info, vb_entry_dt, vb_etc_01, vb_etc_02, vb_etc_03, vb_etc_04, vb_etc_05)";
                    ...
                    //$sql2="insert into vacation_boost_tbl_test (MemberNo ,create_year ,create_month ,degree ,notice_day ,status ,submit_YN ,check_YN ,notes ,remaind_day ,UpdateDate)
                    //values('$re_row[MemberNo]','$this_year','$this_month','2','$year_end2','0','N','N','$year_end2_note','$re_row[remaind_day]',now()); ";
                    $sql2="insert into vacation_boost_tbl_test (vb_member_no, vb_notice_dt, vb_degree, vb_create_year, vb_create_month, vb_status, vb_use_day, vb_remaind_day, vb_update_dt, vb_member_info, vb_entry_dt, vb_etc_01, vb_etc_02, vb_etc_03, vb_etc_04, vb_etc_05)";
...
//$vb_remaind_day=number_format(($vb_remaind_day/8),1);
                        ...
                        if($isNoticeDay3 && $re_row[remaind_day] > "3" && ($year_end3 <= $Todays)){
                            ...
                            $sql3="insert into vacation_boost_tbl_test (vb_member_no, vb_notice_dt, vb_degree, vb_create_year, vb_create_month, vb_status, vb_use_day, vb_remaind_day, vb_update_dt, vb_member_info, vb_entry_dt, vb_etc_01, vb_etc_02, vb_etc_03, vb_etc_04, vb_etc_05)
...
//vb_member_info
                 ...
                 value('$re_row[MemberNo]','$year_end2','2','$this_year','$this_month','0','$tmpData[3]','$rest_day_e2',now(),'$vb_member_info','$enter_starts','$year_end2_note','$year_start','$tmpData[10]','$year_end',''); ";
                            ...
                            $vb_member_info= iconv('euc-kr', 'utf-8', $vb_member_info);
                            //$sql3="insert into vacation_boost_tbl_test (MemberNo ,create_year ,create_month ,degree ,notice_day ,status ,submit_YN ,check_YN ,notes ,remaind_day ,UpdateDate)
...
//$vb_remaind_day=($vb_remaind_day/8);
                       ...
                       // if($isNoticeDay2 && $rest_day_e2 > "0.4" && ($year_end2 <= $Todays)){
                        if($isNoticeDay2 && $rest_day_e2 > "4" && ($year_end2 <= $Todays)){
                            $sql  = " Delete ";
                            $sql .= " From ";
                            $sql .= "     vacation_boost_tbl_test ";
                            $sql .= " Where vb_member_no = '$re_row[MemberNo]' ";
                 ...
                 value('$re_row[MemberNo]','$year_end2','2','$this_year','$this_month','0','$tmpData[3]','$rest_day_e2',now(),'$vb_member_info','$enter_starts','$year_end2_note','$year_start','$tmpData[10]','$year_end',''); ";
                       ...
                       // }else if($isNoticeDay1 && $rest_day_e2 > "0.4" && ($year_end1 <= $Todays)){
                        }else if($isNoticeDay1 && $rest_day_e2 > "4" && ($year_end1 <= $Todays)){
                            $sql  = " Delete ";
                            $sql .= " From ";
                            $sql .= "     vacation_boost_tbl_test ";
                            $sql .= " Where vb_member_no = '$re_row[MemberNo]' ";
